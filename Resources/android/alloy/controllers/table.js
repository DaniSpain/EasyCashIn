function Controller() {
        ...
        while (rowset.isValidRow()) {
            ...
            btnPdf.addEventListener("click", function(e) {
                if (e.source.pdf) {
                    ...
                    var f;
                    f = Ti.Filesystem.getFile(Ti.Filesystem.externalStorageDirectory, fileName);
    ...
    posPay ? $.__views.__alloyId32.addEventListener("click", posPay) : __defers["$.__views.__alloyId32!click!posPay"] = true;
